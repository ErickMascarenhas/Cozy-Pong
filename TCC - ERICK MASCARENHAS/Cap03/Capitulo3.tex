...
A Tabela~\ref{tab:parametros} consolida a parametrização numérica das duas configurações. Todos os mapas rítmicos do projeto foram escritos com uma nota por batida, o que torna a densidade de bolas uma função direta do andamento: a cada $n$ batidas uma bola é servida, de modo que a taxa é de $\mathrm{BPM}/n$ bolas por minuto. As duas configurações exploram essa relação, combinando andamento e fator de subdivisão para separar as faixas de densidade sem sobreposição.
